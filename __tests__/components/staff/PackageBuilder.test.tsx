...
describe('PackageBuilder Component', () => {
  ...
  it('renders configure package dialog when opened', () => {
    ...
    expect(
      screen.getByDisplayValue('Traffic Records Request')
    ).toBeInTheDocument();
  });
  ...
  it('displays associated records information', () => {
    ...
    expect(
      screen.getByText('Police Department Records • 3 pages')
    ).toBeInTheDocument();
  });
  ...
  it('shows package summary', () => {
    ...
    expect(
      screen.getByText(/• Cover sheet with request details/)
    ).toBeInTheDocument();
  ...
  it('closes dialog when Cancel clicked', () => {
    ...
    renderWithTheme(<PackageBuilder {...defaultProps} onClose={mockOnClose} />);
  ...
  it('renders with closed state', () => {
    renderWithTheme(<PackageBuilder {...defaultProps} open={false} />);
