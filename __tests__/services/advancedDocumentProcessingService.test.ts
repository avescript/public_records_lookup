...
const mockPIIDetection = piiDetectionService as jest.Mocked<typeof piiDetectionService>;
const mockAgencyRules = agencyRedactionRulesService as jest.Mocked<typeof agencyRedactionRulesService>;
...
describe('AdvancedDocumentProcessingService', () => {
  ...
  describe('File Type Detection', () => {
    ...
    test('should fallback to extension-based detection', () => {
      const unknownPdfFile = new File(['test'], 'test.pdf', { type: 'application/octet-stream' });
      // @ts-ignore - accessing private method for testing
  ...
  describe('Single Document Processing', () => {
    test('should process text file successfully', async () => {
      const txtFile = new File(['Sample text content'], 'test.txt', { type: 'text/plain' });
    ...
    test('should handle processing with disabled features', async () => {
      const txtFile = new File(['Sample text'], 'test.txt', { type: 'text/plain' });
    ...
    test('should handle processing errors gracefully', async () => {
      mockPIIDetection.detectPII.mockRejectedValue(new Error('PII detection failed'));
  ...
  describe('Agency Validation', () => {
    test('should validate documents against agency rules', async () => {
      const txtFile = new File(['SSN: 123-45-6789'], 'test.txt', { type: 'text/plain' });
    ...
    test('should handle agency validation errors', async () => {
      mockAgencyRules.getAgencyTemplate.mockRejectedValue(new Error('Template error'));
  ...
  describe('Integration Tests', () => {
    test('should integrate PII detection and agency validation', async () => {
      const txtFile = new File(['Name: John Doe, SSN: 123-45-6789'], 'test.txt', { type: 'text/plain' });
