...
export function MatchResults({
  ...
  const [decisions, setDecisions] = useState<Map<string, CandidateDecision>>(
    new Map()
  );
          ...
          {hasDecision && decision.decidedAt && (
            ...
            >
              <Typography variant='body2'>
                {isAccepted ? 'Accepted' : 'Rejected'} by {decision.decidedBy}{' '}
                on{' '}
                {format(
            ...
            <Box>
              ...
              <Typography variant='body2'>
                ...
                {candidate.metadata.pageCount &&
                  ` • ${candidate.metadata.pageCount} pages`}
    ...
    return (
      <Box sx={{ textAlign: 'center', py: 6 }}>
        ...
        <Alert severity='info' sx={{ maxWidth: 400, mx: 'auto' }}>
          Try refining your request description or check if the records
          you&apos;re looking for have been digitized.
        </Alert>
      </Box>
    );
  };
  ...
  const renderSearchMetadata = () => {
    ...
    return (
      <Paper elevation={0} sx={{ p: 2, backgroundColor: 'grey.50', mb: 3 }}>
        <Typography variant='caption' color='text.secondary'>
          Search completed in {searchMetadata.processingTimeMs}ms • Scanned{' '}
          {searchMetadata.totalCandidatesScanned} records • Confidence
          threshold: {formatScore(searchMetadata.confidenceThreshold)}
        </Typography>
      </Paper>
    );
  };
            ...
            {matchResult.candidates.length === 0 ? (
              ...
              <Box>
                ...
                <Typography
                  ...
                  sx={{ mb: 3 }}
                >
                  Results ranked by relevance. Review each match and accept the
                  ones that are relevant to this request.
                </Typography>
