...
const sampleRequests: Omit<RequestFormDataWithFiles, 'files'>[] = [
  {
    ...
    department: 'police',
    description:
      'Requesting police incident report for traffic accident on Main Street on September 10, 2025. Need details for insurance claim.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'fire',
    description:
      'Requesting fire safety inspection records for commercial building at 123 Business Ave for the past year.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'clerk',
    description:
      'Requesting meeting minutes and audio recordings from city council meetings in August 2025.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'finance',
    description:
      'Requesting detailed budget allocations and expenditures for Parks and Recreation department for fiscal year 2025.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'other',
    description:
      'Requesting copies of building permit applications for residential properties on Oak Street submitted in the last 6 months.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'police',
    description:
      'Requesting body camera footage from incident #12345 that occurred on September 5, 2025, involving officer badge #789.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'other',
    description:
      'Requesting environmental compliance reports and inspection records for waste management facilities in the city limits.',
    dateRange: {
      startDate: '2025-01-01',
      endDate: '2025-09-16',
      preset: 'Year to date',
...
export const seedTestData = async () => {
  ...
  try {
    for (let i = 0; i < sampleRequests.length; i++) {
      ...
      console.log(
        `✅ Created request ${i + 1}/${sampleRequests.length}: ${result.trackingId}`
      );
...
export const clearTestData = async () => {
  console.log(
    '🧹 This would clear test data - implement if needed for development'
  );
