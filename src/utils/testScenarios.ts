...
export const EXISTING_REQUESTS: Omit<RequestFormDataWithFiles, 'files'>[] = [
  {
    ...
    department: 'police',
    description:
      'Requesting all use of force reports, body camera footage logs, and incident summaries for July, August, and September 2025. This is for a investigative series on police accountability in our community.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'police',
    description:
      'Defense attorney requesting all documentation related to criminal case #2025-4387, including: police reports, witness statements, evidence logs, and officer notes. Client: Marcus Johnson, charged with burglary.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'finance',
    description:
      'Requesting detailed expenditure reports for the Department of Public Works, including contractor payments, equipment purchases, and overtime records for fiscal year 2025. Specifically interested in road maintenance and infrastructure spending.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'other',
    description:
      'Requesting all building code violation notices, citations, and inspection reports for properties in the downtown district (zip code 12345) for the past 18 months. Need for compliance research on potential property acquisition.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'fire',
    description:
      'Academic research request for anonymized emergency response data including: call volumes, response times, incident types, and resource allocation patterns. This data will be used for a study on urban emergency services efficiency.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'clerk',
    description:
      'Requesting all city council executive session minutes that are now public record, along with any related correspondence and legal opinions. Particularly interested in discussions about development projects and personnel matters.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'other',
    description:
      'Requesting all environmental impact assessments, permits, and compliance reports for the proposed Riverside Development Project. Include all consultant reports, public comments, and agency correspondence.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'police',
    description:
      'Requesting anonymized records of police officer training completions including: de-escalation training, firearms qualifications, mental health crisis training, and continuing education hours for 2024-2025.',
    dateRange: {
      startDate: '2024-01-01',
      endDate: '2025-09-01',
      preset: 'Custom range',
  ...
  },
  {
    ...
    department: 'other',
    description:
      'Requesting all water quality test results, lab reports, and compliance documentation for the municipal water supply system. Include any violation notices, corrective actions, and EPA correspondence.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'other',
    description:
      'Requesting data on building permit fees collected, processing times, and approval rates for residential construction permits. Need breakdown by permit type and construction value for business planning purposes.',
    dateRange: {
  ...
  },
  {
    ...
    department: 'police',
    description:
      'Requesting index of body camera footage logs related to use of force incidents in Q3 2025. Need timestamps, incident reference numbers, and officer badge numbers (names can be redacted). This is for accountability reporting.',
    dateRange: {
      startDate: '2025-07-01',
      endDate: '2025-09-30',
      preset: 'Q3 2025',
  ...
  },
  {
    ...
    department: 'other',
    description:
      'Comprehensive request for all records related to the Riverside Development Project including environmental impact assessments, permits, public comments, consultant reports, and agency correspondence. Citizen oversight of major development.',
    dateRange: {
      startDate: '2023-01-01',
      endDate: '2025-09-25',
...
export const STATUS_SCENARIOS = {
  ...
  rejected:
    'Request cannot be fulfilled due to exemption or other legal restriction',
};
...
export const seedExistingRequests = async (): Promise<TestTrackingIds> => {
  ...
  try {
    for (let i = 0; i < EXISTING_REQUESTS.length; i++) {
      ...
      console.log(
        `✅ Created existing request ${i + 1}/${EXISTING_REQUESTS.length}: ${result.trackingId}`
      );
...
export const resetTestScenario = async () => {
  console.log(
    '🔄 This would reset all test data - implement with caution for production'
  );
...
export const DEMO_SCRIPT = {
  ...
  steps: [
    ...
    },
    {
      ...
      expectedOutcome:
        'Demonstrate Epic 4 features: PII detection, redaction, approval workflow',
    },
    {
      step: 5,
      role: 'Admin/Staff',
