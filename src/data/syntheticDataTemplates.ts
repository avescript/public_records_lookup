...
export const REQUEST_TEMPLATES: SyntheticRequestTemplate[] = [
  // Police Department Templates
  {
    ...
    description:
      'Request for all use of force incident reports for the period {timeRange}. Include officer reports, witness statements, administrative review documentation, and body camera footage logs.',
    complexity: 'complex',
  ...
  },
  {
    ...
    department: 'traffic',
    description:
      'Traffic citation records for {location} including citation numbers, violation codes, dates, and fine amounts for the period {timeRange}.',
    complexity: 'simple',
  ...
  },
  {
    ...
    department: 'training',
    description:
      'Police officer training completion records for {trainingType} including certification dates, instructor information, and training evaluation scores.',
    complexity: 'medium',
  ...
  // Fire Department Templates
  {
    ...
    description:
      'Fire department emergency response data for {district} including call volumes, response times, incident types, and resource allocation for {timeRange}.',
    complexity: 'medium',
  ...
  },
  {
    ...
    description:
      'Fire safety inspection reports for {businessType} establishments including violation notices, compliance documentation, and follow-up inspection records.',
    complexity: 'simple',
  ...
  // Finance Department Templates
  {
    ...
    department: 'budget',
    description:
      'Detailed expenditure report for {department} including contractor payments, equipment purchases, overtime records, and budget variance analysis for fiscal year {fiscalYear}.',
    complexity: 'complex',
  ...
  },
  {
    ...
    description:
      'Vendor contract documentation for {contractType} including bid documents, contract terms, payment schedules, and performance evaluations.',
    complexity: 'medium',
  ...
  // Public Works Templates
  {
    ...
    department: 'streets',
    description:
      'Maintenance and repair records for {infrastructure} including work orders, contractor invoices, inspection reports, and project completion documentation.',
    complexity: 'medium',
  ...
  },
  {
    ...
    description:
      'Environmental impact assessment documentation for {project} including consultant reports, public comments, agency correspondence, and permit applications.',
    complexity: 'complex',
  ...
  // Legal Department Templates
  {
    ...
    description:
      'Legal case file documentation for {caseType} cases including pleadings, discovery materials, settlement negotiations, and court orders.',
    complexity: 'complex',
  ...
  },
  {
    ...
    department: 'advisory',
    description:
      'Legal opinion memoranda regarding {topic} including research analysis, statutory interpretation, and recommended courses of action.',
    complexity: 'medium',
    expectedRecordCount: 8,
    commonKeywords: [
      'legal opinion',
  ...
  // Parks and Recreation Templates
  {
    ...
    description:
      'Usage reports and booking records for {facility} including reservation schedules, maintenance logs, and incident reports for {timeRange}.',
    complexity: 'simple',
    expectedRecordCount: 12,
    commonKeywords: [
      'facility usage',
  ...
  },
  {
    ...
    description:
      'Participation statistics and enrollment data for recreation programs including demographic breakdowns, program evaluations, and budget impact analysis.',
    complexity: 'medium',
...
export const DOCUMENT_TEMPLATES: SyntheticDocumentTemplate[] = [
  // Police Documents
  {
    ...
    description:
      'Police incident report documenting {incidentType} at {location} on {date}. Includes officer observations, witness statements, evidence collection, and follow-up actions.',
    documentType: 'pdf',
  ...
  },
  {
    ...
    description:
      'Body camera footage inventory and metadata for incident #{reportNumber}. Includes timestamp logs, officer assignments, video quality notes, and evidentiary chain of custody.',
    documentType: 'pdf',
    classification: 'restricted',
    keyPhrases: [
      'body camera',
  ...
  },
  {
    ...
    description:
      'Comprehensive use of force incident documentation including officer justification, supervisor review, witness accounts, medical evaluation, and administrative determination.',
    documentType: 'pdf',
  ...
  // Fire Department Documents
  {
    ...
    description:
      'Emergency response documentation for call #{callNumber} including dispatch information, response times, personnel assignments, actions taken, and outcome summary.',
    documentType: 'pdf',
  ...
  },
  {
    ...
    description:
      'Fire safety inspection report for {businessName} including code compliance assessment, violation notices, recommended corrective actions, and re-inspection scheduling.',
    documentType: 'pdf',
    classification: 'standard',
    keyPhrases: [
      'fire inspection',
  ...
  // Finance Department Documents
  {
    ...
    description:
      'Comprehensive expenditure analysis for {department} fiscal year {year} including line-item breakdowns, budget variances, contractor payments, and year-over-year comparisons.',
  ...
  },
  {
    ...
    description:
      'Contract agreement with {vendorName} for {contractType} services including terms and conditions, payment schedules, performance metrics, and compliance requirements.',
    documentType: 'pdf',
    classification: 'standard',
    keyPhrases: [
      'contract agreement',
  ...
  // Public Works Documents
  {
    ...
    description:
      'Infrastructure condition assessment for {roadName} including pavement analysis, drainage evaluation, traffic impact study, and maintenance recommendations.',
    documentType: 'pdf',
  ...
  },
  {
    ...
    description:
      'Environmental impact assessment for {projectName} including ecological surveys, water quality analysis, air quality monitoring, and mitigation measures.',
    documentType: 'pdf',
    classification: 'standard',
    keyPhrases: [
      'environmental impact',
  ...
  // Legal Department Documents
  {
    ...
    description:
      'Legal opinion memorandum regarding {topicArea} including statutory analysis, case law research, regulatory compliance assessment, and recommended actions.',
    documentType: 'pdf',
    classification: 'restricted',
    keyPhrases: [
      'legal opinion',
  ...
  },
  {
    ...
    source: 'Legal Department',
    description:
      'Complete litigation file for {caseName} v. City including pleadings, discovery responses, expert witness reports, settlement negotiations, and court orders.',
    documentType: 'pdf',
    classification: 'confidential',
    keyPhrases: [
      'litigation file',
  ...
  // Parks and Recreation Documents
  {
    ...
    description:
      'Monthly usage report for {facilityName} including reservation statistics, maintenance activities, incident reports, and revenue analysis.',
    documentType: 'spreadsheet',
    classification: 'standard',
    keyPhrases: [
      'facility usage',
  ...
  },
  {
    ...
    description:
      'Program enrollment and participation data for {programName} including participant demographics, attendance records, feedback evaluations, and budget impact.',
    documentType: 'pdf',
    classification: 'restricted',
    keyPhrases: [
      'program enrollment',
...
export const TEMPLATE_VARIABLES = {
  ...
  fiscalYear: ['2024-2025', '2023-2024', '2025-2026'],
  contractType: [
    'IT services',
